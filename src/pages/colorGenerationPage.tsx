import {Component, createContext, createSignal, Accessor, Setter, useContext, createEffect} from "solid-js";
...
const ColorGenerationPage: Component = () => {
  ...
  const [colors, setColors] = createSignal(Object.entries(ScalePrimObj)), colorObj: ColorArrContextType = [
    colors,
    setColors
  ];
