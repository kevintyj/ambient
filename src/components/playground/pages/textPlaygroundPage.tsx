					...
					<For each={textSizes}>
						{size => (
							<LinkAnchor size={size}>
								This is the default link of size
								{' '}
								{size}
								<HelperBadge margin>
									{Object.keys(visibleColorScale())[focused()[1]].toLocaleLowerCase()}
									{' '}
									07
								</HelperBadge>
							</LinkAnchor>
