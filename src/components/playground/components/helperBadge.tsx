...
const HelperBadge: IHelperProps = (props) => {
  ...
  if (helper() || props.active) return(
    <>
      <div class="rounded bg-helper-transparent inline-block text-sm font-normal font-sans text-center
      text-helper-primary px-2 py-0.5 capitalize" classList={{'mx-4': props.margin}}>
