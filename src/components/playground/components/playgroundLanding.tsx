  ...
  return (
    ...
    <div class="flex flex-col pb-3 overflow-hidden rounded -m-6 sm:-m-8">
      ...
      <section class="flex items-center p-16 ">
        <div class="flex flex-col gap-4 w-9/12 max-w-xl">
          <h1 class="text-5xl heading font-bold">
            Let your imagination run <div class="heading-special inline">wild!</div>
          </h1>
          <h2 class="text-2xl paragraph">
            Contrast safe, tested, and beautiful colors! <br/>
          ...
          <div class="hint">
            <i class="bi bi-arrow-90deg-down pr-2"/>See what we are all about
          </div>
        </div>
      ...
      <section class="flex flex-col p-16 py-12 bg-neutral-00">
        ...
        <p class="paragraph pb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
          sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
          Ut enim ad minim veniam, quis nostrud exercitation ullamco
          laboris nisi ut <b class="bold">aliquip ex ea commodo consequat.</b></p>
        <div class="flex flex-row gap-8">
          <div class="bg-neutral-01 p-8 rounded-md">
            ...
            <a class="link font-semibold underline cursor-pointer">Read More <i class="bi bi-arrow-right"/> </a>
          </div>
          <div class="bg-neutral-01 p-8 rounded-md">
      ...
      <section class="flex flex-col md:flex-row p-16 py-12 gap-12 items-center">
        <div class="flex flex-col">
          ...
          <p class="paragraph pb-8">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
            ...
            est laborum.</p>
          <DefaultButton type="default">
            Read our blog post <i class="bi bi-arrow-right pl-1"/>
          </DefaultButton>
        </div>
        <img class="flex rounded-md w-full md:w-2/5 h-auto object-cover"
