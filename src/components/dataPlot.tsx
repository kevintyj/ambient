...
type IDataPlotProps<T = object> = Component<T & {
...
const DataPlot: IDataPlotProps = (props) => {
	...
	return (
		<div class="flex flex-col grow">
			<h2 class="text-slate-800 dark:text-slate-200 pb-2">
			...
			>
				<div class="w-full h-full relative mx-6 my-[35px]">
					<For each={colorsRemap()}>
						{(swatch, i) => (
							<div
								class="h-[20px] w-[20px] rounded-md absolute border
